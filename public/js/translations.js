...
const translations = {
    ...
    hi: {
        ...
        // Additional translations for Hindi
        benefitsAccessedToday: "आज प्राप्त लाभ",
        activeFarmers: "सक्रिय किसान",
        integratedSchemes: "8+ सरकारी योजनाओं के साथ एकीकृत",
        accessBenefits: "एकीकृत प्लेटफ़ॉर्म के माध्यम से सभी किसान लाभ प्राप्त करें",
        pmKisan: "पीएम-किसान",
        pmKisanDescription: "₹6,000 वार्षिक प्रत्यक्ष हस्तांतरण 9.8 करोड़ किसानों के लिए",
        kisanCreditCard: "किसान क्रेडिट कार्ड",
        kisanCreditCardDescription: "7% ब्याज दर, ₹3 लाख बिना गारंटी सीमा",
        pmFasalBima: "पीएम फसल बीमा",
        pmFasalBimaDescription: "व्यापक फसल बीमा, कम प्रीमियम",
        agriStack: "एग्री-स्टैक डीपीआई",
        agriStackDescription: "₹6,000 करोड़ डिजिटल कृषि अवसंरचना",
        totalSchemeBenefits: "कुल योजना लाभ उपलब्ध",
        farmersEnrolled: "किसान पहले से ही नामांकित",
        processingTime: "औसत प्रसंस्करण समय",
        completeSolutions: "पूर्ण कृषि वित्त समाधान",
        innovativeProducts: "सरकारी योजनाओं से परे - आधुनिक खेती के लिए अभिनव वित्तीय उत्पाद",
        whrLending: "डब्ल्यूएचआर-आधारित ऋण",
        whrLendingDescription: "प्रतिस्पर्धी दरों और त्वरित स्वीकृति के साथ वेयरहाउस रसीदों के खिलाफ सुरक्षित ऋण।",
        liveAuctions: "लाइव फसल नीलामी",
        liveAuctionsDescription: "हमारे पारदर्शी ऑनलाइन नीलामी प्लेटफ़ॉर्म के माध्यम से अपनी फसलों के लिए सर्वोत्तम मूल्य प्राप्त करें।",
        secureDocuLocker: "सुरक्षित डॉक्यूलॉकर",
        secureDocuLockerDescription: "अपने सभी कृषि दस्तावेज़ों को सुरक्षित रूप से क्लाउड में संग्रहीत और प्रबंधित करें।",
        accessLocker: "लॉकर तक पहुँचें",
        aiAdvisory: "एआई-संचालित कृषि सलाह",
        aiAdvisoryDescription: "मौसम डेटा, मिट्टी की सेहत, बाजार के रुझान, और सरकारी योजना सिफारिशों को मिलाकर हमारे उन्नत एआई सहायक के साथ सूचित निर्णय लें।",
        weatherIntelligence: "मौसम बुद्धिमत्ता",
        weatherIntelligenceDescription: "इष्टतम फसल योजना के लिए वास्तविक समय मौसम अलर्ट और मौसमी पूर्वानुमान।",
        marketInsights: "बाजार अंतर्दृष्टि",
        marketInsightsDescription: "आपके मुनाफे को अधिकतम करने के लिए मूल्य पूर्वानुमान और मांग पूर्वानुमान।",
        smartRecommendations: "स्मार्ट सिफारिशें",
        smartRecommendationsDescription: "योजनाओं, ऋणों, और खेती के तरीकों पर व्यक्तिगत सलाह।",
        aiAssistant: "कृषिमित्र एआई सहायक",
        alwaysHereToHelp: "हमेशा मदद के लिए यहाँ",
        aiAdvice1: "आपके स्थान और फसल के आधार पर, आप पीएम-किसान (₹2,000 मार्च के लिए देय) के लिए पात्र हैं और मानसून से पहले फसल बीमा पर विचार करना चाहिए।",
        aiAdvice2: "मौसम चेतावनी: अगले सप्ताह भारी बारिश की उम्मीद है। तैयार फसलों की कटाई करें और बीमा कवरेज की जाँच करें।",
        tryAiAssistant: "एआई सहायक आज़माएं",
        successStories: "वास्तविक सफलता की कहानियाँ",
        transformingLives: "देखें कि कैसे किसान कृषिमित्र के साथ अपनी ज़िंदगी बदल रहे हैं",
        rajeshKumar: "राजेश कुमार",
        wheatFarmer: "गेहूं किसान, यूपी",
        rajeshStory: "कृषिमित्र ने मुझे मेरे गेहूं डब्ल्यूएचआर के खिलाफ ₹1.2 लाख ऋण 24 घंटे में प्राप्त करने में मदद की। इसके अलावा, मुझे समय पर मेरा पीएम-किसान भुगतान मिला!",
        sunitaDevi: "सुनीता देवी",
        riceFarmer: "चावल किसान, बिहार",
        sunitaStory: "फसल नीलामी सुविधा ने मुझे स्थानीय मंडी की तुलना में 15% अधिक मूल्य दिलाया। एआई सहायक ने मेरी फसल को कीट हमले से भी बचाया।",
        prakashPatil: "प्रकाश पाटिल",
        cottonFarmer: "कपास किसान, महाराष्ट्र",
        prakashStory: "डॉक्यूलॉकर में मेरे सभी दस्तावेज़ों ने केसीसी आवेदन को सुपर आसान बना दिया। 2 दिनों में स्वीकृत हो गया, हफ्तों के बजाय!",
        chooseRole: "अपनी भूमिका चुनें और अपनी यात्रा शुरू करें",
        accessFeatures: "कृषि पारिस्थितिकी तंत्र में आपकी भूमिका के लिए विशेष रूप से डिज़ाइन की गई सुविधाओं तक पहुँचें",
        imFarmer: "मैं एक किसान हूँ",
        farmerAccess: "ऋण, सरकारी योजनाओं, नीलामियों, और एआई सलाह सेवाओं तक पहुँचें।",
        applyWhrLoans: "डब्ल्यूएचआर-आधारित ऋणों के लिए आवेदन करें",
        checkSchemeEligibility: "सरकारी योजना पात्रता की जाँच करें",
        participateAuctions: "फसल नीलामियों में भाग लें",
        getAiAdvisory: "एआई-संचालित सलाह प्राप्त करें",
        enterAsFarmer: "किसान के रूप में प्रवेश करें",
        imWarehouseManager: "मैं एक वेयरहाउस प्रबंधक हूँ",
        warehouseAccess: "सूची प्रबंधन, डब्ल्यूएचआर उत्पन्न करें, और वेयरहाउस संचालन की देखरेख करें।",
        generateWhrs: "डिजिटल डब्ल्यूएचआर उत्पन्न करें",
        manageInventory: "सूची और जमा प्रबंधित करें",
        trackCollaterals: "ऋण गारंटी का ट्रैक रखें",
        updateSettings: "वेयरहाउस सेटिंग्स अपडेट करें",
        enterAsWarehouseManager: "वेयरहाउस प्रबंधक के रूप में प्रवेश करें",
        exploreFirst: "पहले अन्वेषण करना चाहते हैं?",
        tryDemo: "इंटरएक्टिव डेमो आज़माएं",
        krishiMitra: "कृषिमित्र",
        poweredByDb: "डॉयचे बैंक द्वारा संचालित",
        transformingAgriculture: "डिजिटल नवाचार और वित्तीय समावेशन के माध्यम से कृषि को बदलना।",
        services: "सेवाएं",
        support: "समर्थन",
        digitalMission: "भारत के डिजिटल कृषि मिशन का हिस्सा | सरकारी स्वीकृत वित्तीय सेवाएं"
    },
